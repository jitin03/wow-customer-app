            ...
            child: Container(
              child: _providerDetails.when(
                data: (_data) {
                  ...
                  } else if (serviceName.contains("Maid")) {
                    default_image = "assets/images/maid-default-images.png";
                  } else if (serviceName.contains("Subscription")) {
                    default_image = "assets/images/maid-default-images.png";
                  } else {
                                ...
                                children: [
                                  ...
                                  Container(
                                    child: ListView.separated(
                                      ...
                                      shrinkWrap: true,
                                      itemCount:
                                          _data.providerReviews.length > 4
                                              ? 3
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                Accordion(
                    title: "Fan Motors", content: ACFanMotorServiceData()),
                Accordion(
                    title: "Gas Charging", content: ACGasChargeServiceData()),
              ],
            ),
          ),
        );
