...
class _StepperDemoState extends ConsumerState<StepperDemo> {
  ...
  String? address;
  bool isBookingDetailComplete(address) {
    // if(_currentStep==0){
  ...
  Widget build(BuildContext context) {
    ...
    var customerDetails = ref.watch(customerProfileDataProvider);
    var customerCoupons =
                      ...
                      child: StatefulBuilder(builder: (context, setState) {
                        return Stepper(
                                  ...
                                  Expanded(
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        print(
                                            'Custom action executed on last step');
                                        ...
                                        for (int index = 0;
                                          ...
                                          subCategories.price = _providerDetails
                                              ...
                                              .subCategory![index]
                                              .price;
                                          subCategories.count = cartList?[index]
                                                  .count
                                                  .toString() ??
                                              "";
                                          if (int.parse(subCategories.count!) >
                                              0) {
                                            subCategoriesList
                                                .add(subCategories);
                                          }
                                        ...
                                        serviceList.subCategories =
                                            subCategoriesList;
                                        serviceLists.add(serviceList);

                                        bookingRequest.serviceLists =
                                            serviceLists;
                                        bookingRequest.discountPrice =
                                            (totalAmount *
                                        ...
                                        bookingRequest.couponCode =
                                            apply_coupon == 'Apply Coupon'
                                                ? "No Coupon"
                                                : apply_coupon;
                                        bookingRequest.discountRate =
                                            discountRate;
                                        bookingRequest.gstPrice = double.parse(
                                                totalAmount
                                                    .toStringAsFixed(2)) *
                                            0.18;
                                        bookingRequest.grossAmount = widget
                                                .serviceName!
                                                .contains("AC Repair")
                          ...
                          onStepContinue: () {
                            ...
                            if (address == "self" &&
                                _scheduleController.text.isEmpty) {
                              // Do not allow moving to the next step
                              return;
                            }
                            bool isBookingDetailValid =
                                isBookingDetailComplete(address);
                            if (_currentStep == 1) {
                              // TODO: add your custom action here
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            softWrap:
                                                                                true,
                                                                            _data.providerDetails.serviceLists![indexOfServiceName].subCategory![index].name!,
                                                                            style: TextStyle(
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        RoundedIconButton(
                                                                          ...
                                                                          onPress:
                                                                              () {
                                                                            ref.read(cartListProvider).decrement(index);
                                                                            setState(() {
                                                                              isEdit = true;
                                                                            });
                                                                          },
                                                                        ...
                                                                        RoundedIconButton(
                                                                          ...
                                                                          onPress:
                                                                              () {
                                                                            ref.read(cartListProvider).increment(index);
                                                                            setState(() {
                                                                              isEdit = true;
                                                                            });
                                                                          },
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            '\u{20B9}' +
                                                                                (cartList[index].price! * (cartList[index].count!)).toStringAsFixed(1),
                                                                            style:
                                                                ...
                                                                InkWell(
                                                                  onTap:
                                                                    ...
                                                                    if (apply_coupon ==
                                                                      ...
                                                                      var customerCoupons =
                                                                          ref.watch(
                                                                              providerCustomerCouponProvider(widget.serviceName!));
                                                                          ...
                                                                          return StatefulBuilder(builder:
                                                                            ...
                                                                            return Container(
                                                                              ...
                                                                              child: customerCoupons.when(
                                                                                data: (_data) {
                                                                                  List<WowCustomerCoupons> coupons = _data.coupons;
                                                                                  List<WowCustomerCoupons> referralCoupons = _data.referralCoupons;

                                                                                  Set<WowCustomerCoupons> uniqueCoupons = Set<WowCustomerCoupons>.from(coupons);
                                                                                  for (WowCustomerCoupons referralCoupon in referralCoupons) {
                                                                                    uniqueCoupons.add(referralCoupon);
                                                                                  }

                                                                                  coupons = uniqueCoupons.toList();
