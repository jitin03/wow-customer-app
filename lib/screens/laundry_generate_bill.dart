                            ...
                            (discountRate != null)
                                ? Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          "- \u{20B9}${(double.parse(_data[0].grossAmount) * discountRate / 100).toStringAsFixed(2)}",
                                ...
                                Container(
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        onTap: () async {
                                          if (apply_coupon == "Apply Coupon") {
                                            var customerCoupons = ref.watch(
                                                  ...
                                                  return Container(
                                                    ...
                                                    child: customerCoupons.when(
                                                      data: (_data) {
                                                        ...
                                                        List<WowCustomerCoupons>
                                                        referralCoupons = _data.referralCoupons;
                                                        coupons.addAll(referralCoupons);
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed: _wowCoupon.text != null && _wowCoupon.text.isNotEmpty // Check if _wowCoupon.text is not empty
                                                                                ? () async {
                                                                                    ...
                                                                                    ValidateCouponResponse resp = await ref.read(couponProvider).validateWowCoupon(_wowCoupon.text.toUpperCase(),widget.serviceName);
                                                                  ...
                                                                  children: [
                                                                    Align(
                                                                      ...
                                                                      Text(
                                                                        "Available Coupons",
                                                                        style:
                                                                        TextStyle(fontFamily: 'Work Sans', fontSize: 16),
                                                                      ),
                                                                    ),
                                                                    SizedBox(
                                                                      height:
